    ...
    <Card className="relative flex gap-4 p-4 transition-shadow hover:shadow-md sm:p-5">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <div className="flex items-start justify-between gap-2">
          <h3 className="pr-6 font-semibold leading-tight text-foreground text-pretty">
        ...
        <div className="mt-1 flex flex-wrap items-center gap-x-2 gap-y-1 text-sm">
          <span className="font-medium text-foreground">{oferta.nombre_tutor ?? "Tutor"}</span>
          {oferta.rating && (
            <>
              ...
              <span className="text-muted-foreground">({oferta.reviews ?? 0} reseñas)</span>
            </>
          )}
        </div>
        ...
        <div className="mt-1.5 flex items-center gap-1 text-sm text-muted-foreground">
          ...
          <span>
            {oferta.modalidad}{oferta.lugar_especifico ? ` · ${oferta.lugar_especifico}` : ""}
          </span>
        </div>
        ...
        <div className="mt-3 flex items-end justify-between gap-2">
          ...
          <div className="text-right">
            <span className="text-lg font-bold text-foreground">{formatPrecio(oferta.precio_referencial)}</span>
