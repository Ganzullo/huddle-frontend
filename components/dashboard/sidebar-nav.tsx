  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-2">
        <Button asChild className="w-full justify-start rounded-full bg-[#0070f3] text-white hover:bg-[#0070f3]/90">
          <Link href="/publicar-oferta">
            <Plus className="size-4" />
            Publicar oferta
          </Link>
        </Button>
        <Button asChild variant="outline" className="w-full justify-start rounded-full bg-transparent">
